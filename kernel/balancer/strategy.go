...
var StrategyMap = map[uint8]StrategyBalancer{
	dispose.BalancerPattern["random"]: RandomBalancer,        // 随机
	dispose.BalancerPattern["round"]:  RoundBalancer,         // 轮询
	dispose.BalancerPattern["weight"]: WeightedRoundBalancer, // 带权重的轮询
}
